  ...
  Future _getData() async {
    try {
      final response = await http.get(Uri.parse(
          ...
          "http://192.168.100.37/baru/barang/api/list.php"));
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                Edit(kode_item: _get[index]['kode_item'])));
                  },
                  child: Card(
                    ...
                    child: Container(
                      ...
                      constraints: BoxConstraints(minHeight: (index % 2 + 2)),
